...
execute store result score *check.check armorfx_var run data modify storage armorfx:var check.remove.item set from storage armorfx:var check.removed[{Slot:100b}].id
data merge storage armorfx:var {check:{remove:{part:"boots"}}}
execute if score *check.check armorfx_var matches 1.. run function armorfx:internal/check/remove with storage armorfx:var check.remove
execute store result score *check.check armorfx_var run data modify storage armorfx:var check.remove.item set from storage armorfx:var check.removed[{Slot:101b}].id
data merge storage armorfx:var {check:{remove:{part:"leggings"}}}
execute if score *check.check armorfx_var matches 1.. run function armorfx:internal/check/remove with storage armorfx:var check.remove
execute store result score *check.check armorfx_var run data modify storage armorfx:var check.remove.item set from storage armorfx:var check.removed[{Slot:102b}].id
data merge storage armorfx:var {check:{remove:{part:"chestplate"}}}
execute if score *check.check armorfx_var matches 1.. run function armorfx:internal/check/remove with storage armorfx:var check.remove
execute store result score *check.check armorfx_var run data modify storage armorfx:var check.remove.item set from storage armorfx:var check.removed[{Slot:103b}].id
data merge storage armorfx:var {check:{remove:{part:"helmet"}}}
execute if score *check.check armorfx_var matches 1.. run function armorfx:internal/check/remove with storage armorfx:var check.remove
